...
export const SlideWrapper = ({ avatarFace }) => {
    return (
        <SwiperSlide className="w-[150px] aspect-square rounded-sm m-2 ring-[#E50914] ring-offset-4 ring-offset-[#141414] hover:ring-[4px] relative">
