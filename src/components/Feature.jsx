...
const Feature = ({ heading, sub, urlOne, index, urlTwo }) => {
    ...
    return (
        <div className={`bg-black w-full text-white flex gap-26 border-b-8 border-b-[#232323] justify-center min-h-[580px] items-center ${(index % 2 == 1) ? `flex-row-reverse gap-10` : ``}`} id="feature-section">
