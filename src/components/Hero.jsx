...
const Hero = () => {
    ...
    return (
        <div>
            <div className="banner w-full h-[700px] border-b-8 border-b-[#3f3f3f] brightness-50">   
            </div>           
            <div className="w-full absolute z-5 top-0">
                <div className="w-[60%] mx-auto flex flex-col gap-52">
                        ...
                        <div className="text-center flex flex-col gap-4">
                            <h1 className="text-5xl font-extrabold text-white">Unlimited Movies, TV shows and more</h1>
                            ...
                            <div className="flex w-6/12 mx-auto items-center flex-wrap relative">
                                ...
                                <p className={`text-gray-400 text-md font-bold absolute left-[17px] top-4 ${(isFocused == true ) ? `top-[5px] text-[13px]` : ``} transition-all ease-linear duration-150 `}>Email address</p>
