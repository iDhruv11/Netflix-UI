const validateEmail = (emailValue) => {
    ...
    if(emailValue == "") return "email can't be empty!";    
    if(indexOfATR == 0 || indexOfATR == -1) return "No @";
    if(indexOfDot == 0 || indexOfDot == -1) return "NO Dot";
    if(indexOfDot - indexOfATR <= 1) return "Invalid mail client"
    if(emailValue[indexOfDot + 1] == undefined || emailValue[indexOfDot + 2] == undefined) return "no or one char long domain name";
...
const useValidate = (emailValue=null, passValue=null, nameValue=null) => {
